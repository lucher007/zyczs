...
public class MedMarketStatAction extends BaseAction implements ModelDriven<MedStat>{
	...
	public String getMedSellStat() {
		...
		form.setPager_count(medStatDao.getMarketMedSellStatCount(form));
		form.setMedStatlist(medStatDao.getMarketMedSellStatList(form));
		form.setStrsumweight(medStatDao.getMarketMedSellStatWeight(form));
