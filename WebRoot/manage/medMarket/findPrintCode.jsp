...
<html>
	...
	<div id="body">
		...
		<div class="lst-box">
			...
			<div class="page">
				<cite>
				<pg:pager url="medMarket!findPrintCode.shtml"
	...
	<script type="text/javascript">
		function checkForm(){
			...
			$("#searchform").attr("action","medMarket!findPrintCode.shtml");
			$("#searchform").submit();
		}
    ...
    function printData_print(storageidtemp){
		$.dialog({
			...
			id:'medChos',
			lock:true,
			content: '<iframe frameborder="0" scrolling="no" name="tFrame" id="tFrame" width="800" height="580" src="<%=basePath%>printCode!findByStorageId_med.shtml?ischoice='+Math.random()+'&storageid='+storageidtemp+'&url=medMarket!findPrintCode.shtml"></iframe>',
			close:function(){
