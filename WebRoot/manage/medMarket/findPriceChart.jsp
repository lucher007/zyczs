...
<html>
  ...
  <body>
  	<div id="body">
		...
		<div class="seh-box">
				...
				<input type="hidden" id="corptype" name="corptype" value="0">
				<input type="hidden" id="cpccorp" name="cpccorp" value="${User.cpccorp}">
				<input type="hidden" id="indexweekperiod" name="indexweekperiod" value="${indexweekperiod }">
					<span>请选择品名查询:</span>
	  				<select id="sel_mainMeds" onchange="changeVal()" style="width: 80px">
 ...
 $(function () {
 	...
 	$("#btn_month").click(function(){
	 	...
	 	$("#myform").attr("action","indexUser!findPriceChart_medMarket.shtml");
	 	$("#myform").submit();
 	});
