...
<html>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.list}" var="storlist">
		          <tr class="lb-list">
		            ...
		            <td><a href="<%=basePath%>check!findByCheckDetail.shtml?medstorid=${storlist.medstorid }&type=0&flag=medmarket" class="btn-look">查看</a></td>          
		          </tr>
	          </c:forEach>           
			</table>
	...
	<script type="text/javascript">
		...
		function checkForm(){
			...
			$("#searchform").attr("action","medStorage!findCheckedList.shtml?flag=medmarket");
			$("#searchform").submit();
		}
	</script>
	</body>
