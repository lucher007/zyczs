...
<html>
	...
	<div id="body">
		...
		<div class="seh-box">
			<cite><a href="<%=basePath %>/manage/medSellInOutStorage/findOutCode.jsp" class="btn-a"><span class="out">药材出库</span>
			</a> </cite>
		...
		<div class="lst-box">
			...
			<div class="page">
				<cite>
				<pg:pager url="medMarket!findMedOutStorage.shtml"
	...
	<script type="text/javascript">
		...
		function checkForm(){
			...
			$("#searchform").attr("action","medMarket!findMedOutStorage.shtml");
			$("#searchform").submit();
		}
	</script>		
	</body>
