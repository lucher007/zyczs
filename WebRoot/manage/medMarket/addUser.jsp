...
<html>
	...
	<div id="body">
		...
		<form action="<%=basePath%>company!addUserMarket.shtml" id="dataForm" name="dataForm" method="post">
		<s:token></s:token>
		<input type="hidden" name="zyctype" id="zyctype" value="01000000">
		<!-- <input type="hidden" name="corpshortname" id="corpshortname"> -->
		<input type="hidden" name="province" id="province" value="${User.org.province}">
		<input type="hidden" name="city" id="city" value="${User.org.city}">
		<input type="hidden" name="area" id="area" value="${User.org.area}">
		<input type="hidden" id="marketcode" name="marketcode" value="${User.cpccorp }" >
		
		<div class="form-box">
			<div class="fb-tit">新经营户添加</div>
		    <div class="reg-box mt10">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		          ...
		          <tr>
		            ...
		            <td width="170">
		            	<input type="text" class="inp" name="corpname" id="corpname" maxlength="50" onblur="checkVal(this.name);" value="${corpname}"> <span class="red">*</span>
		            </td>
		           ...
		           <tr>
		            ...
		            <td width="170">
		            	<input type="text" class="inp" name="corpshortname" id="corpshortname" maxlength="50" onblur="checkVal(this.name);" value="${corpshortname}"> <span class="red">*</span>
		            </td>
		          ...
		          <tr>
		            ...
		            <td>
			            <input type="text" class="inp" name="businesscode" id="businesscode" maxlength="22" onblur="checkVal(this.name);" value="${businesscode }"> <span class="red">*</span>
					</td>
		          ...
		          <tr>
		            ...
		            <td><input type="text" class="inp" name="orgcode" id="orgcode" maxlength="10" onblur="checkVal(this.name);" value="${orgcode }"> </td>
		          ...
		          <tr>
		            ...
		            <td>
		            	<input type="text" class="inp" name="masterman" id="masterman" maxlength="10" onblur="checkVal(this.name);" value="${masterman }"> <span class="red">*</span>
					</td>
		            <td colspan="3"><label name="mastermanLab" id="mastermanLab" class="noico"></label></td>
                     ...
                     <tr>
		          	...
		          	<td><input type="text" class="inp" name="identitycard" id="identitycard" maxlength="18" onblur="checkVal(this.name);" value="${identitycard }"> <span class="red">*</span></td>
		          	<td colspan="3"><label name="identitycardLab" id="identitycardLab" class="noico"></label></td>
                     </tr>
                     
                     <tr>
		            <td height="30" align="right">联系人：</td>
                       <td><input type="text" class="inp" name="linkman" id="linkman" maxlength="10" onblur="checkVal(this.name);" value="${linkman}"><span class="red">*</span></td>
		          ...
		          <tr>
		            ...
		            <td>
		            	<input type="text" class="inp" name="mobile" id="mobile" maxlength="11" onblur="checkVal(this.name);" onkeyup="onkeyupCheck(this);" onkeypress="onkeypressCheck(this);" value="${ mobile}"> <span class="red">*</span>
					</td>
		          ...
		          <tr>
		            ...
		            <td>
		            	<input type="text" class="inp" name="telephone" id="telephone" maxlength="20" onblur="checkVal(this.name);" value="${ telephone}"> <span class="red">*</span>
					</td>
		          ...
		          <tr>
		            ...
		            <td>
		            	<input type="text" class="inp" name="officephone" id="officephone" maxlength="20" onblur="checkVal(this.name);" value="${ officephone}"> <span class="red">*</span>
					</td>
		          ...
		          <tr>
		            ...
		            <td>
		            	<input type="text" class="inp" name="email" id="email" maxlength="30" onblur="checkVal(this.name);" value="${email }">
					</td>
		          ...
		          <tr>
		            ...
		            <td>
		            	<input type="text" class="inp" name="postcode" id="postcode" maxlength="6" onblur="checkVal(this.name);" onkeyup="onkeyupCheck(this);" onkeypress="onkeypressCheck(this);" value="${ postcode}"> 
		            </td>
		          ...
		          <tr>
					...
					<td>
		            	<input type="text" class="inp" name="registeraddress" id="registeraddress" maxlength="50" onblur="checkVal(this.name);" value="${registeraddress }"> <span class="red">*</span>
					</td>
		          ...
		          <tr>
					...
					<td>
		            	<input type="text" class="inponly" name="partion" id="partion" readonly="readonly" value="${partion }">
					</td>
					<td colspan="3"></td>
		          </tr>
		           ...
		           <tr>
					...
					<td>
		            	<input type="text" class="inponly" name="coordinate" id="coordinate" readonly="readonly" value="${coordinate }">
					</td>
	...
	function checkVal(name){
		...
		if(name=="corpname"){
			if(nameval==null||nameval==""){
				checkerror(name);
				namelab.html("商户名称没有输入");
				return false;
	    	}
			if(checkquotmarks(nameval)){
				checkerror(name);
				namelab.html("名称不能包含~ # *等字符");
				return false;
			}
			...
			$.getJSON(url,{'corpname':nameval}, function(data) {
				if(data.model.returncode==1){
					checkerror(name);
					namelab.html(data.model.returninfo.replace("企业","商户"));
					return false;
				}
			});
			checksuccess(name);
		...
		if(name=="corpshortname"){
			if(nameval==null||nameval==""){
				checkerror(name);
				namelab.html("商户简称没有输入");
				return false;
	    	}
			if(checkquotmarks(nameval)){
				checkerror(name);
				namelab.html("简称不能包含~ # *等字符");
				return false;
			}
			checksuccess(name);
		}
