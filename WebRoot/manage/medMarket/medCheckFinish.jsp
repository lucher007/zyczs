...
<html>
	...
	<script type="text/javascript" language="javascript">    
	    function findByList(type){
	        if(type==0){
				window.location.href="<%=basePath%>medStorage!findCheckList.shtml?flag=medmarket";
	        }else{
	    		window.location.href="<%=basePath%>medStorage!findCheckedList.shtml?flag=medmarket";
	        }
		}
	</script>   	
</body>
