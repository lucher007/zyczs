...
<!--					</td>-->
				...
				<c:forEach items="${list}" var="item">
					<tr class="lb-list">
						...
						<td>
							${item.totalweight/10000 }
						</td>
<!--						<td>-->
<!--							<a class="btn-look" href="<%=basePath %>medMarket!findMedStorage.shtml?batchcpc=${item.cpcmed }">详情</a>-->
<!---->
<!--						</td>-->
					</tr>
				</c:forEach>
			...
			<div class="page">
				<cite>
				<pg:pager url="medMarket!findMedGroupStorage.shtml"
	...
	<script type="text/javascript">
		...
		function checkForm(){
			...
			$("#searchform").attr("action","medMarket!findMedGroupStorage.shtml");
			$("#searchform").submit();
		}
	</script>
	</body>
