				        ...
				        <tr>
			  			...
			  			<tr>
	  						...
	  						<td><input type="text" class="inp" name="intime" id="intime"
	  						 style="background: #ffffff url('images/growaddunittime.png') no-repeat right;" 
	  						 onfocus="WdatePicker({skin:'blueFresh',isShowWeek:true,dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'harvesttime\');}'});" value="${intime }"><span class="red">*</span></td>
			  			</tr>
					</table>
				</div>
	...
	<script language="javascript" type="text/javascript" src="/js/comtools.js"></script>
		<script type="text/javascript" language="javascript">
			...
			$("#searchform").submit(function(){
				...
				$("#searchform").attr("action", "<%=basePath%>medMarket!notSourceMedSave.shtml");
			});
