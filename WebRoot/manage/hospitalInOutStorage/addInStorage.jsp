...
<div id="body">
		...
		<div class="form-box">
	    	...
	    	<c:if test="${fn:length(sessionScope.hospitalInStoragemap.listMap)>0}">
	        ...
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.hospitalInStoragemap.listMap}" var="instoragemap" varStatus="vs">
	        ...
	        <c:if test="${fn:length(sessionScope.hospitalInStoragemap.failList)>0}">	
	        ...
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.hospitalInStoragemap.failList}" var="failList">              
	              <tr class="fb-list">
    ...
    <script type="text/javascript">
		...
		function goBack(){
			window.location="<%=basePath %>/manage/hospitalInOutStorage/findInStorage.jsp";
		}	

		function checkForm(){
			$("#searchform").attr("action", "hospitalInOut!addInStorage.shtml");		
