...
<!--		              销售企业名称： <input maxlength="50" type="text" name="sellcorpname" id="sellcorpname" value="${requestScope.sellcorpname }" class="inp"/>-->
		    ...
		    <div class="lst-box">
		    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		          ...
		          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
			  	   <tr class="lb-list">
			  		...
			  		<td>
						<a class="btn-look" href="<%=basePath %>inOutStorBox!findTabletInStorBox_hospital.shtml?inoutstorid=${inoutstorage.inoutstorid }&zstype=${inoutstorage.zstype }">查看</a>
					</td> 
			  	  </tr>
		  		  </c:forEach>
		        </table>
		        <div class="page">
					<cite>
					<pg:pager url="inOutStor!findTabletInStor_hospital.shtml"
	...
	<script type="text/javascript">
		function checkForm(){
			...
			$("#searchform").attr("action","inOutStor!findTabletInStor_hospital.shtml");
			$("#searchform").submit();
		}	   
	</script>
