...
<!--	                    <td>总重量(kg)：<b class="red">${requestScope.inoutstorage.totalweight/10000 }</b></td>-->
<!--	                </tr>-->
<!--	 			</table>-->
...
<!--		            <td>包数</td>-->
		          ...
		          <c:forEach items="${requestScope.boxitemlist}" var="boxitem">
			  	  <tr class="fb-list">
			  		...
			  		<td width="20%">${boxitem.boxweight/10000 }&nbsp;</td>
<!--			  		<td width="20%">${boxitem.boxitemnum }&nbsp;</td>-->
			  	  </tr>
		  		  </c:forEach>
		        </table>
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findTabletInStorItem_hospital.shtml"
	...
	<script type="text/javascript">
	    function goBack(){
	        $("#searchform").attr("action","inOutStorBox!findTabletInStorBox_hospital.shtml");
			$("#searchform").submit();
	    }
	</script>
	</body>
