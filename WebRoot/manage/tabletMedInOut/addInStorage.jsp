...
<div id="body">
		...
		<div class="cur-pos">当前位置：药材库存管理 > 药材入库</div>
		<div class="form-box">
	    	
	    	<c:if test="${fn:length(sessionScope.tabletMedSellInStoragemap.listMap)>0}">
	        ...
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.tabletMedSellInStoragemap.listMap}" var="instoragemap" varStatus="vs">
	        ...
	        <c:if test="${fn:length(sessionScope.tabletMedSellInStoragemap.failList)>0}">	
	        ...
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.tabletMedSellInStoragemap.failList}" var="failList">              
	              <tr class="fb-list">
    ...
    <script type="text/javascript">
		...
		function goBack(){
			window.location="<%=basePath %>/manage/tabletMedInOut/findInStorage.jsp";
		}	

		function checkForm(){
			$("#searchform").attr("action", "tabletMedInOut!addInStorage.shtml");
