	...
	<div id="body">
	    ...
	    <div class="seh-box">
	        <form action="" method="post" name="searchform" id="searchform">
	                         输入品名：<input type="text" maxlength="50" name="tabletname" id="tabletname" value="${requestScope.tabletname}" size="45" class="inp"/>
	    	...
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.tabletlist}" var="tabletlist">
		  	  <tr class="lb-list">
		  		...
		  		<td>${tabletlist.meduseweight/10000 }</td>
		  		<td>${tabletlist.createtime}</td>
		  		<td><a href="<%=basePath%>tablet!findById_unchecked.shtml?tabletid=${tabletlist.tabletid }" class="btn-test" >检验</a></td>
		  	  </tr>
	  		  </c:forEach>
	        </table>
	        <div class="page">
	        	<cite>
					<pg:pager
					    url="tablet!findByList_unchecked.shtml"
		...
		<script type="text/javascript">
			function checkForm(){
				...
				$("#searchform").attr("action","tablet!findByList_unchecked.shtml");
				$("#searchform").submit();
			}
