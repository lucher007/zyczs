...
<html>
	...
	<div id="body">
	    <div class="seh-box">
	        <form name="searchform" id="searchform" action="<%=request.getContextPath()%>/scoreDeduct!companyChoice.shtml" method="post">
	        <table cellpadding="0" cellspacing="0" width="100%" border="0">
	  			<tr>
	  				<td width="80">单位名称：</td>
	  				<td><input type="text" maxlength="20" class="inp" size="45" name="orgname" id="orgname" value="${orgname}" /></td>
	  				<td width="80">&nbsp;</td>
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr class="lb-list">
	            ...
	            <input type="hidden" id="province_${list.orgid }" value="${list.province }" >
	            <input type="hidden" id="city_${list.orgid }" value="${list.city }" >
	            <input type="hidden" id="area_${list.orgid }" value="${list.area }" >
	            <input type="hidden" id="zyctype_${list.orgid }" value="${list.zyctype }" >
	            <input type="hidden" id="orgid_${list.orgid }" value="${list.orgid }" >	
	            </td>
	            <td>${list.orgname }&nbsp;</td>
	            <td>${list.cpccorp }&nbsp;</td>   
         	...
         	<div class="page">
        		<cite>
            		<pg:pager
				    url="scoreDeduct!companyChoice.shtml"
	...
	$(".lb-list").click(function(){
		...
		selArray[3]=$("#province_"+t).val();
		selArray[4]=$("#city_"+t).val();
		selArray[5]=$("#area_"+t).val();
		selArray[6]=$("#zyctype_"+t).val();
		selArray[7]=$("#orgid_"+t).val();
