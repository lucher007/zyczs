...
<html>
	...
	<body>
	<div id="body">
	    <div class="cur-pos">当前位置：诚信评价 > 处罚管理</div>
	    <div class="seh-box">
	        <form action="" method="post" name="searchform" id="searchform">
	        	企业名称： <input maxlength="20" type="text" name="orgname" id="orgname" value="${requestScope.orgname }" class="inp w100"/>
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.scoredeductlist}" var="scoredeductlist">
			  	  <tr class="lb-list">
			  	  	<td>${scoredeductlist.orgname }</td>
			  	  	<td>${scoredeductlist.cpccorp }</td>
			  		<td height="30">
	        ...
	        <div class="page">
	        	<cite>
					<pg:pager
					    url="scoreDeduct!findByListSelectAll.shtml"
	...
	<script type="text/javascript">
		function checkForm(){
			...
			$("#searchform").attr("action","scoreDeduct!findByListSelectAll.shtml");
			$("#searchform").submit();
		}
