	...
	<div class="form-box">
        ...
        <div class="fb-con">
		    ...
		    <table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
	            ...
	            <td align="center">数量(单位:Kg)</td>
	          </tr>
		  	  <tr class="fb-list">
		  		<td height="30" align="center">药材库存量</td>
		  		<td align="center">
		  		${(build.medstorweight==null || build.medstorweight == '')?'0':build.medstorweight }&nbsp;
		  		</td>
		  	  </tr>
		  	  <tr class="fb-list">
		  		<td height="30" align="center">饮片库存量</td>
		  		<td align="center">
		  		${(build.tabletstorweight==null || build.tabletstorweight == '')?'0':build.tabletstorweight }&nbsp;
		  		</td>
		  	  </tr>
		  	  <tr class="fb-list">
		  		<td height="30" align="center">药材交易量</td>
		  		<td align="center">
		  		${(build.medtradeweight==null || build.medtradeweight == '')?'0':build.medtradeweight }&nbsp;
		  		</td>
		  	  </tr>
		  	  <tr class="fb-list">
		  		<td height="30" align="center">饮片交易量</td>
		  		<td align="center">
		  		${(build.tablettradeweight==null || build.tablettradeweight == '')?'0':build.tablettradeweight }&nbsp;
		  		</td>
		  	  </tr>
		  	  <tr class="fb-list">
		  		<td height="30" align="center">交易总量</td>
		  		<td align="center">
		  		${(build.totaltradeweight==null || build.totaltradeweight == '')?'0':build.totaltradeweight }&nbsp;
		  		</td>
		  	  </tr>
            </table>
            <br/>
...
<script type="text/javascript">
   function checkForm(){
		$("#searchform").attr("action","rp_Build!storAndTradeQuery.shtml");
		$("#searchform").submit();
	}	   
   
   function checkForm_exp(){
		$("#searchform").attr("action","rp_Build!storAndTradeStat_excel.shtml");
		$("#searchform").submit();
	}	
