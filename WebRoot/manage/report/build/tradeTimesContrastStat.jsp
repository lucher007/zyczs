...
<script type="text/javascript">
   function checkForm(){
		...
		$("#searchform").attr("action","rp_Build!tradeTimesContrastStat.shtml");
		$("#searchform").submit();
	}	   
   ...
   $(function () {
       $('#container').highcharts({
        ...
        series: [{
            name: '${fn:substring(opertime,0,11)}交易量',
            marker: {
                symbol: 'square'
            },
            data: [
              ...
              ${buildmap['12']/10000}
	            ...
	            name: '${fn:substring(opertime,0,11)-1}交易量',
	            marker: {
	                symbol: 'diamond'
	            },
	            data: [
		              ${buildcontrastmap['01']/10000},
		              ${buildcontrastmap['02']/10000},
		              ${buildcontrastmap['03']/10000},
		              ${buildcontrastmap['04']/10000},
		              ${buildcontrastmap['05']/10000},
		              ${buildcontrastmap['06']/10000},
		              ${buildcontrastmap['07']/10000},
		              ${buildcontrastmap['08']/10000},
		              ${buildcontrastmap['09']/10000},
		              ${buildcontrastmap['10']/10000},
		              ${buildcontrastmap['11']/10000},
		              ${buildcontrastmap['12']/10000}
	            ]
        	}
        ]
    });
