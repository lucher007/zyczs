	...
	<div class="form-box">
        ...
        <div class="fb-con">
	        ...
	        <form action="" method="post" name="searchform" id="searchform">
	          <table width="100%">
                  <tr>
                    <td height="26"  align="right">计划发放总数：</td>
                    <td>
		            	<input type="text" style="width:60px" name="plansendnum" id="plansendnum" maxlength="7" value="${requestScope.plansendnum }" onkeyup="onkeyupCheck(this);" onkeypress="onkeypressCheck(this);">
		            </td>
...
<script type="text/javascript">
   ...
   function checkForm(){
		$("#searchform").attr("action","rp_Build!chengSendStat.shtml");
		$("#searchform").submit();
	}	   
