...
<div id="body">
	...
	<div class="form-box">
        ...
        <div class="fb-con">
        	...
        	<cite>
            	<pg:pager
				    url="rp_Build!orgCodeNumQuery.shtml"
...
<script type="text/javascript">
   function checkForm(){
		$("#searchform").attr("action","rp_Build!orgCodeNumQuery.shtml");
		$("#searchform").submit();
	}	   
   
   function checkForm_exp(){
		$("#searchform").attr("action","rp_Build!orgCodeNumStat_excel.shtml");
		$("#searchform").submit();
	}	
