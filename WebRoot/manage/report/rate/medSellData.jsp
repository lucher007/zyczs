...
<html>
  <head>
	...
	function checkForm(){
        document.searchform.action="rp_Rate!medSellData.shtml";
        if($('#year').val()==""){
        	alert("请输入日期");
        	return;
        }
    ...
    $('#container').highcharts({
        ...
        series: [{
            ...
            <c:forEach items="${requestScope.list}" var="rlist">
            	...
            	<fmt:formatNumber value="${rlist.medweight/1000}" pattern="##.##" minFractionDigits="2" ></fmt:formatNumber>
            	,
			</c:forEach>
            ]
        }]
...
<div id="body">
	    <div class="cur-pos">当前位置：统计分析 > 溯源药材销售量</div>
	    <div class="seh-box">
