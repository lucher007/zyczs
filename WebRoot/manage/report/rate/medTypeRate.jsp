...
<html>
  <head>
	...
	function checkForm(){
        document.searchform.action="rp_Rate!medTypeRate.shtml";
        if($('#month').val()==""){
        	alert("请输入日期");
        	return;
        }
    ...
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
            	...
            	<c:if test="${rlist.medtype==0}">
            	['溯源',${rlist.medweight}],
            	</c:if>
                <c:if test="${rlist.medtype==1}">
            	['非溯源',${rlist.medweight}],
            	</c:if>
				</c:forEach>
            ]
...
<div id="body">
	    <div class="cur-pos">当前位置：统计分析 > 溯源药材入库所占比</div>
	    <div class="seh-box">
