...
<body onload="checkprice();resetH();">
	...
	<div id="body">
		<div class="cur-pos">当前位置：库存管理 > 药材出库</div>
		<div id="content1" style="display:block;">
			
			<div class="form-box">
	    		
	    		<c:if test="${fn:length(sessionScope.medOutStoragemap)>0}">
	    		<div class="fb-tit">待出库药材成功列表
	        	...
	        	<div class="fb-con">
		        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
		              ...
		              <c:forEach items="${sessionScope.medOutStoragemap}" var="outstoragemap" varStatus="vs">
		              	<tr id="tr_${vs.index }">
		        ...
		        <div class="fb-tit tpline">待出库药材失败列表</div>
		        <div class="fb-con">
		        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
		              <tr class="fbc-tit">
...
<%--		                	<c:if test="${failList.reason=='0'}">溯源码不存在</c:if>--%>
		...
		<%--	              </tr>--%>
			              ...
			              <!-- 溯源企业时显示-->
			              <!-- 非溯源企业时显示-->
			              <table id="tbody2" width="100%" class="hide" border="0">
				              <tr>
...
<%--    <script language="javascript" type="text/javascript" src="<%=basePath%>js/My97DatePicker/WdatePicker.js"></script>--%>
    <script type="text/javascript">
		...
		function goBack(){
			window.location="<%=basePath %>/manage/medInOutStorage/findOutStorage.jsp";
		}
				...
				$.getJSON(url,function(msg){
					if(msg.state=="")
					{
						$.dialog.confirm('验证成功、确认要提交吗？', function(){ 
							cm.close();						
							$("#searchform").attr("action", "inOutStor!addOutStorageMed.shtml");
							$("#searchform").submit();	
