    ...
    <div id="body">
	    ...
	    <div class="seh-box">
	        <form action="" method="post" name="searchform" id="searchform">
	                             ...
	                             采购企业： <input maxlength="50" type="text" size="15" name="buycorpname" id="buycorpname" value="${requestScope.buycorpname }" class="inp"/>
		                   出库时间： 从
		        ...
		        <input type="hidden" name="mmedid" id="medid" />
	        </form>
	    </div>
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
		  	   <tr class="lb-list">
		  	    <td width="15%" height="30">${inoutstorage.prodname }&nbsp;</td>
		  		<td width="25%">
		  		...
		  		<td width="10%">
					<a class="btn-look" href="<%=basePath %>inOutStorBox!findMedOutStorBox_med.shtml?inoutstorid=${inoutstorage.inoutstorid }">详情</a>
				</td> 
		  	  </tr>
	  		  </c:forEach>
	        </table>
	        <div class="page">
				<cite>
				<pg:pager url="inOutStor!findMedOutStor_med.shtml"
...
<script type="text/javascript">
	function checkForm(){
		...
		$("#searchform").attr("action","inOutStor!findMedOutStor_med.shtml");
		$("#searchform").submit();
	}
</script>
