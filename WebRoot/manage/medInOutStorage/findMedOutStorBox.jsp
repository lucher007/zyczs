...
<html>
	...
	<body>
	<div id="body">
		<div class="cur-pos">当前位置：库存销售  &gt; 出库查询</div>
		<div class="form-box">
	        ...
	        <div class="fb-con">
	            <table cellpadding="0" cellspacing="0" border="0" width="100%">
	                <tr>
	                    ...
	                    <td width="20%">总价(元)：<b class="red">${requestScope.inoutstorage.strtotalmoney }</b></td>
	                </tr>
	 			</table>
                <table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
		          ...
		          <c:forEach items="${requestScope.inoutstorboxlist}" var="inoutstorbox">
			  	  <tr class="fb-list">
			  		...
			  		<td><a href="<%=basePath %>inOutStorBox!findMedOutStorItem_med.shtml?inoutstorboxid=${inoutstorbox.inoutstorboxid }&inoutstorid=${requestScope.inoutstorid }" class="btn-bag">${inoutstorbox.boxnum }</a></td>
		        ...
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findMedOutStorBox_med.shtml"
