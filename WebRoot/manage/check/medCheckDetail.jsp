...
<html>		
  	...
  	<body>
  	<div id="body">
	  	<div class="cur-pos">当前位置：检验管理 > 已检药材详情</div>
		<div class="form-box">
	        ...
	        <div class="fb-con">
	            <table cellpadding="0" cellspacing="0" border="0" width="100%">
	              <tr>
	                  <td height="30" >批次号：${check.cpcmed }</td>
	                  <td>品名：${check.medname }</td>
	              </tr>
	              <tr>
	                  <td height="30" >执行标准：${check.checkmethod }</td>
	                  <td>检验人员：${check.checkuser }</td>
	              </tr>
	              <tr>
	                  <td height="30" >贮藏条件：${check.checkcondition }</td>
	...
	<script type="text/javascript" language="javascript">
    	...
    	function displayuploaddiv(){
    		...
    		$.getJSON(url,{medstorid:'${check.prodid}',type:'${check.type}',orgid:'${check.orgid}'}, function(data) {
	    		var loginForm = data;
