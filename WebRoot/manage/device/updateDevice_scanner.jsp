...
<html>
    		...
    		<div class="fb-tit">扫描设备修改</div>
	       	<div class="fb-con">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		          ...
		          <tr>
		            <td height="30" align="right">扫描设备备注信息：</td>
                    <td >
   ...
   $("#selectCpccorp").click(function(){
	...
	function updateDevice(){
		...
		$("#searchform").attr("action", "<%=basePath%>device!updateDevice_scanner.shtml");
		$("#searchform").submit();
	}
