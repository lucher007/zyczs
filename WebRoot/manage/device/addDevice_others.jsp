...
<html>
	...
	<div id="body">
	    ...
	    <div class="form-box">
    		<div class="fb-tit">其他设备发放</div>
	       	<div class="fb-con">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		           <tr >
		            <td height="30" width="170" align="right">其他设备编号：</td>
		            <td width="290">
		          ...
		          <tr>
		            <td height="30" align="right">回收原其他设备：
                    </td>
                    <td>
		           ...
		           <tr id="recDeviceCodeTR" style="display:none">
		            <td height="30"  align="right">回收其他设备编号：</td>
                    <td >
		          ...
		          <tr id="recConfidTR" style="display:none">
		            <td height="30" align="right">回收其他设备规格：</td>
                    <td >
	...
	function checkDeviceCode(devicecode){
	    ...
	    if(devicecode != null && devicecode != ''){
		    ...
		    $.ajax({
		    	url: "<%=basePath%>device!checkDeviceCode.shtml?devicetype=9&devicecode=" + devicecode,
		    	type: 'post',
   ...
   $("#selectCpccorp").click(function(){
	...
	function saveDevice(){
		...
		$("#searchform").attr("action", "<%=basePath%>device!saveDevice_others.shtml");
		$("#searchform").submit();
	}
    ...
    function queryDevice(cpccorp){
	    t2 = $.dialog({
			...
			id:'cpccorpWindow',
			lock:true,
			content: '<iframe frameborder="0" scrolling="no" name="tFrame" id="tFrame" width="650" height="300" src="'+"<%=basePath%>device!deviceChoice.shtml?devicetype=9&cpccorp="+cpccorp+"&ischoice="+Math.random()+'"></iframe>'
		 });
