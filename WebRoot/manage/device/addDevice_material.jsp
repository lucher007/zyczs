...
<html>
	...
	<div id="body">
	    ...
	    <div class="form-box">
    		<div class="fb-tit">耗材发放</div>
	       	<div class="fb-con">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		           <tr >
		            <td height="30" width="130" align="right">耗材编号：</td>
		            <td width="290">
		          ...
		          <tr>
		            <td height="30" align="right">回收原耗材：
                    </td>
                    <td>
		           ...
		           <tr id="recDeviceCodeTR" style="display:none">
		            <td height="30"  align="right">回收耗材编号：</td>
                    <td >
		          ...
		          <tr id="recConfidTR" style="display:none">
		            <td height="30" align="right">回收耗材规格：</td>
                    <td >
	...
	function checkDeviceCode(devicecode){
	    ...
	    if(devicecode != null && devicecode != ''){
		    ...
		    $.ajax({
		    	url: "<%=basePath%>device!checkDeviceCode.shtml?devicetype=6&devicecode=" + devicecode,
		    	type: 'post',
   ...
   $("#selectCpccorp").click(function(){
	...
	function saveDevice(){
		...
		$("#searchform").attr("action", "<%=basePath%>device!saveDevice_material.shtml");
		$("#searchform").submit();
	}
    ...
    function queryDevice(cpccorp){
	    t2 = $.dialog({
			...
			id:'cpccorpWindow',
			lock:true,
			content: '<iframe frameborder="0" scrolling="no" name="tFrame" id="tFrame" width="650" height="300" src="'+"<%=basePath%>device!deviceChoice.shtml?devicetype=6&cpccorp="+cpccorp+"&ischoice="+Math.random()+'"></iframe>'
		 });
