...
<html>
	...
	<div id="body">
	    <div class="seh-box">
	        <form name="searchform" id="searchform" action="<%=request.getContextPath()%>/device!companyChoice.shtml" method="post">
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr class="lb-list">
	            ...
	            <input type="hidden" id="mobile_${list.orgid }" value="${list.mobile }" >		
	            </td>
	            <td>${list.orgname }&nbsp;</td>
	            <td>${list.cpccorp }&nbsp;</td>   
         	...
         	<div class="page">
        		<cite>
            		<pg:pager
				    url="device!companyChoice.shtml"
