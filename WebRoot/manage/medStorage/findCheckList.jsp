...
<html>
	    	...
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.list}" var="storlist">
		          <tr class="lb-list">
		            ...
		            <td>
		            	<a href="javascript:void(0);" onclick="doCheck('${storlist.medstorid}','${storlist.cpcmed}','${storlist.medname}','${storlist.medweight / 10000}','${storlist.harvesttime}')" class="doCheck btn-test">检验</a>
		            </td>          
		           </tr>
	          </c:forEach>           
	        </table>
	...
	<script type="text/javascript">
		...
		function checkForm() {
			...
			$("#searchform").attr("action","medStorage!findCheckList.shtml?flag=med");
			$("#searchform").submit();
		}
		function doCheck(medstorid,cpcmed,medname,medweight,harvesttime){
			//checkmattype, 检验报告表的类型(type), 为0是药材, 为1是饮片.
			$(".doCheck").attr("href","<%=basePath%>manage/check/medCheck.jsp?medstorid="+medstorid+"&cpcmed="+cpcmed+"&medname="+encodeURI(medname)+"&medweight="+medweight+"&harvesttime="+harvesttime+"&medstate=1&flag=0&checkmattype=0");
		}
