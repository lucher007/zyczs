...
<html>
	...
	<div id="body">
		...
		<div class="seh-box">
			<cite><a href="<%=basePath %>/manage/medSellInOutStorage/findOutCode.jsp" class="btn-a"><span class="new">药材出库</span>
			</a> </cite>
		...
		<div class="lst-box">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<c:forEach items="${list}" var="item">
					<tr class="lb-list">
						...
						<td>
							<a href="printCode!findByBox.shtml?storageid=${item.medstorid }&storagetype=0">查看溯源码</a>
						</td>
					</tr>
				</c:forEach>
			</table>
			...
			<div class="page">
				<cite>
				<pg:pager url="medStorage!findMedOutStorage.shtml"
	...
	<script type="text/javascript">
		...
		function checkForm(){
			...
			$("#searchform").attr("action","medStorage!findMedOutStorage.shtml");
			$("#searchform").submit();
		}
	</script>		
	</body>
