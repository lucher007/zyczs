	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
		  	   <tr class="lb-list">
		  	    <td width="20%">${inoutstorage.prodname}&nbsp;</td>
		  		<td width="20%" height="30">${fn:substring(inoutstorage.opertime, 0, 11)}&nbsp;</td>
		  		<td width="20%">${inoutstorage.strtotalweight }&nbsp;</td>
		  		<td width="10%">
					<a class="btn-look" href="<%=basePath %>inOutStorBox!findMedOutStorBox_tablet.shtml?inoutstorid=${inoutstorage.inoutstorid }">详情</a>
				</td> 
		  	  </tr>
	  		  </c:forEach>
	        </table>
	        <div class="page">
				<cite>
				<pg:pager url="inOutStor!findMedOutStor_tablet.shtml"
