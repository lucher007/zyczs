...
<html>
	...
	<body>
	<div id="body">
		<div class="cur-pos">当前位置：药材库存管理 > 非溯源药材入库</div>
		<div class="form-box">
	    	<form action=""  method="post" name="searchform" id="searchform">
				...
				<div class="fb-con">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
				            <td align="right" height="30">药材产地：</td>	
				            <td colspan="4">
				        ...
				        <tr>
			  				<td align="right" height="30" width="13%">药材品种：</td>
			  				<td width="34%">
			  					<input type="text" class="inp fl" id="medname" name="medname" maxlength="20" value="${medname }"  style="background:#eeeeee;"/>
			  					
			  					<a href="javascript:void(0);" id="xzyc" class="btn-xz fl">选择药材品种</a>
				        ...
				        <tr>
			  				<td align="right" height="30" width="15%">批次号：</td>
			  			...
			  			<tr>
			  				<td align="right" height="30">药材类型：</td>
			  				<td>
			  			...
			  			<tr>
			  				<td align="right" height="30">入库重量(kg)：</td>
			  				<td><input type="text" class="inp" name="medweight" id="medweight" maxlength="6" value="${medweight }" 
								...
								onblur="onkeyblurCheck(this);onBlurCheck(this.name)"><span class="red">*</span>
			  					<span style="color:red; display: none" id="medweightCheck" >请填写重量</span>
			  				</td>
			  				<td><label class="starcss"></label></td>
			  				<td align="right">入库时间：</td>
	  						<td><input type="text"   style="background: #ffffff url('images/growaddunittime.png') no-repeat right;"  class="Wdate inp " name="intime" id="intime" onfocus="WdatePicker({skin:'blueFresh',isShowWeek:true,dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,minDate:'#F{$dp.$D(\'harvesttime\');}'});" value="${intime }"><span class="red">*</span></td>
			  			</tr>
					</table>
				</div>
				<div style="color: red; font-size: 18px">${returninfo }</div>
		        <div class="fb-bom">
		        	<cite><input type="submit" id="subBut" value="下一步" class="sbt" /></cite>
		        </div>
	        </form>
		</div>
	...
	<script language="javascript" type="text/javascript" src="/js/comtools.js"></script>
		<script type="text/javascript" language="javascript">
			...
			$("#searchform").submit(function(){
				...
				$("#searchform").attr("action", "tabletMedStorage!notSourceMedSave.shtml");
			});
