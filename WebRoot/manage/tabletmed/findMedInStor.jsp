...
<html>
	...
	<body>
	    <div id="body">
		    <div class="cur-pos">当前位置：药材库存管理 &gt; 入库查询</div>
		    <div class="seh-box">
...
<!--		              销售企业名称： <input maxlength="50" type="text" name="sellcorpname" id="sellcorpname" value="${requestScope.sellcorpname }" class="inp"/>-->
		    ...
		    <div class="lst-box">
		    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		          ...
		          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
			  	   <tr class="lb-list">
			  		...
			  		<td>
						<a class="btn-look" href="<%=basePath %>inOutStorBox!findMedInStorBox_tablet.shtml?inoutstorid=${inoutstorage.inoutstorid }&zstype=${inoutstorage.zstype }">查看</a>
					</td> 
			  	  </tr>
		  		  </c:forEach>
		        </table>
		        <div class="page">
					<cite>
					<pg:pager url="inOutStor!findMedInStor_tablet.shtml"
	...
	<script type="text/javascript">
		...
		function checkForm(){
			...
			$("#searchform").attr("action","inOutStor!findMedInStor_tablet.shtml");
			$("#searchform").submit();
		}  
	</script>
