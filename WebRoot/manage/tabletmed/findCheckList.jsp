...
<body>
	    	...
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.list}" var="storlist">
		          <tr class="lb-list">
				    ...
				    <td><a href="javascript:void(0);" onclick="doCheck('${storlist.medstorid }','${storlist.medname }','${storlist.medweight / 10000}','${storlist.cpcmed }','${storlist.harvesttime }','${storlist.medstate }')" class="doCheck btn-test">检验</a></td>          
		          </tr>
	          </c:forEach>           
	        </table>
	...
	<script type="text/javascript">
		...
		function doCheck(medstorid,medname,medweight,cpcmed,harvesttime,medstate){
			...
			$(".doCheck").attr("href","<%=basePath%>manage/check/medCheck.jsp?medstorid="+medstorid+"&cpcmed="+cpcmed+"&medname="+encodeURI(medname)+"&medweight="+medweight+"&harvesttime="+harvesttime+"&medstate="+medstate+"&flag=1&checkmattype=0");
		}
		...
		function checkForm(){
			...
			$("#searchform").attr("action","medStorage!findCheckList.shtml?flag=tablet");
			$("#searchform").submit();
		}
	</script>
</body>
