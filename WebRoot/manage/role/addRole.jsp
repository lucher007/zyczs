...
<html>
	...
	<div id="body">
		<div class="cur-pos">当前位置：添加角色</div>
		<form action="role!save.shtml" id="dataForm" name="dataForm" method="post">
		<input type="hidden" name="orgid" id="orgid" value="${requestScope.orgid }" />
	    <div class="form-box">
    		<div class="fb-tit">添加角色</div>
	       	<div class="fb-con">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		          <tr>
		            <td height="30" align="right">角色名称：</td><td>
		            	<input type="text" class="inp w150" name="rolename" id="rolename" maxlength="20" onblur="checkVal(this.name);"> <span class="red">*</span>
		            </td>
		            <td width="150">
	        ...
	        <div class="fb-bom">
		        ...
		        <input type="button" value="返回" class="sbt" onclick="return findByList();">	        
	...
	function checkVal(name){
		...
		if(name=="rolename"){
			...
			$.getJSON(url,{'rolename':nameval,'orgid':orgid}, function(data) {
