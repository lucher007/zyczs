...
<body>
    ...
    <div class="seh-box">
        <form action="scalesbus!findScaleBusMarket.shtml" method="post" id="searchForm" name="searchForm">
        	<input type="hidden" name="usercode" value="${comuser.org.cpccorp}"/>
        	<table width="100%">
        		<tr>
    ...
    <div class="lst-box">
        ...
        <div class="page">
        	<cite>
            	<pg:pager
				    url="scalesbus!findScaleBusMarket.shtml"
					...
					<pg:param name="usercode" value="${comuser.org.cpccorp}"/>
					<pg:index>
