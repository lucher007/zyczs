...
<html>
	...
	<body>
	<div id="body">
	    <div class="cur-pos">当前位置：库存管理 &gt; 库存查询</div>
	    <div class="seh-box">
	        <form action="" method="post" name="searchform" id="searchform">
	            <table border="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td>
                    	<input type="button" value="查询" class="sch" onclick="return findByList();"/>
                    </td>
                  </tr>
                </table>
	        </form>
	    ...
	    <div class="lst-box">
	        ...
	        <div class="page">
	        	<cite>
					<pg:pager
					    url="hospitalStat!findByTabletStorageStat.shtml"
	...
	<script type="text/javascript">
        function findByList(){
			...
			$("#searchform").attr("action","hospitalStat!findByTabletStorageStat.shtml");
			$("#searchform").submit();
		}	
