...
<html>
	...
	<div id="body">
		...
		<form action="company!updateVerify.shtml" id="dataForm" name="dataForm" method="post">
		...
		<div class="form-box">
			    ...
			    <div class="reg-box mt10">
			        <table width="100%" border="0" cellpadding="0" cellspacing="0">
			          ...
			          <tr>
			            ...
			            <td width="170">
			            	<input type="text" class="inponly" id="corpname"  name="corpname" readonly maxlength="50" value="${requestScope.company.corpname }"><span class="red">*</span>
			            </td>
			          ...
			          <tr>
			            ...
			            <td width="170">
			            	<input type="text" class="inponly" id="corpshortname"  name="corpshortname" readonly maxlength="50" value="${requestScope.company.corpshortname }"><span class="red">*</span>
			            </td>
			          ...
			          <tr>
			           ...
			           <tr>
			            ...
			            <td><input type="text" class="inponly" readonly name="orgcode" id="orgcode" maxlength="10" value="${requestScope.company.orgcode }" onblur="checkVal(this.name);"> </td>
			          ...
			          <tr>
						...
						<td>
			            	<input type="text" name="registeraddress" class="inponly" readonly id="registeraddress" maxlength="50" onblur="checkVal(this.name);" value="${requestScope.company.registeraddress }"> <span class="red">*</span>
						</td>
				...
				<div class="fb-bom">
			        ...
			        <cite><input type="button" value="返回审核列表" onclick="goFindCompanyVerify();" class="sbt"></cite>
		...
		<div class="pop-box" id="pop-div">
			<div id="divTitle">
				<table width="520">
					...
					<!-- 
					<tr>
						<td height="30" bgcolor="#EEEEEE" align="right">CA个数：</td><td colspan="3"><br><label id="l_canum" /></label><br></td>
					</tr>
				 -->
				</table>
			</div>
