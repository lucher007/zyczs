					...
					<tr class="lb-list">
					   <td height="30">
						...
						<td>
							...
							<a href="<%=basePath %>fertilizer!saveInit.shtml?cpcplant=${plant.cpcplant }&oper=details">+</a>
						</td>
						<td>
							<a href="<%=basePath %>pesticide!findByList.shtml?cpcplant=${plant.cpcplant}&oper=details">农药 ${plant.pesticide }</a>
							<a href="<%=basePath %>pesticide!saveInit.shtml?cpcplant=${plant.cpcplant }&oper=details">+</a>
						</td>
						 -->
						 <td>
							<a href="<%=basePath %>fieldCare!findByList.shtml?cpcplant=${plant.cpcplant}&oper=details">田间操作 ${plant.fieldcare }</a>
							<a href="<%=basePath %>fieldCare!saveInit.shtml?cpcplant=${plant.cpcplant }&oper=details">+</a>
						</td>
						<td>
							<a href="<%=basePath %>med!findByCpcPlant.shtml?cpcplant=${plant.cpcplant}">收获 ${plant.med }</a>
							<a href="<%=basePath %>plant!initHarverstMed.shtml?cpcplant=${plant.cpcplant }">+</a>
						</td>
						<td>
							<c:if
