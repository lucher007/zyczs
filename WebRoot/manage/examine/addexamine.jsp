...
<html>
	...
	<div id="body">
		<div class="cur-pos">当前位置：考核管理 > 考核地区添加</div>
		<div class="form-box">
	    	<form action="<%=basePath %>examine!save.shtml"  method="post" name="searchform" id="searchform">
			<s:token></s:token>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
						...
						<td colspan="2">
			        		...
			        		&nbsp;<select name="area" id="area" v="${area }"></select><br />
						</td>
					...
					<tr>
						...
						<td width="140">
							<input type="text" class="inp w120" name="medcount" maxlength="6"
								...
								onblur="onkeyupNum(this);onBlurCheck(this.name)" value="${medcount }"/>
								<span class="red">*</span>
						</td>
						<td width="400">
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w120" name="medsellcount" maxlength="6"
								...
								onkeypress="onkeyupNum(this);"
								onkeyup="onkeyupNum(this);"
								onblur="onkeyupNum(this);onBlurCheck(this.name)" value="${medsellcount }"/>
								<span class="red">*</span>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w120" name="medmarketcount" maxlength="6"
								...
								onkeypress="onkeyupNum(this);"
								onkeyup="onkeyupNum(this);"
								onblur="onkeyupNum(this);onBlurCheck(this.name)" value="${medmarketcount }"/>
								<span class="red">*</span>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w120" name="tabletcount" maxlength="6"
								...
								onkeypress="onkeyupNum(this);"
								onkeyup="onkeyupNum(this);"
								onblur="onkeyupNum(this);onBlurCheck(this.name)" value="${tabletcount }"/>
								<span class="red">*</span>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w120" name="tabletsellcount" maxlength="6"
								...
								onkeypress="onkeyupNum(this);"
								onkeyup="onkeyupNum(this);"
								onblur="onkeyupNum(this);onBlurCheck(this.name)" value="${tabletsellcount }"/>
								<span class="red">*</span>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w120" name="tablethospcount" maxlength="6"
								...
								onkeypress="onkeyupNum(this);"
								onkeyup="onkeyupNum(this);"
								onblur="onkeyupNum(this);onBlurCheck(this.name)"  value="${tablethospcount }"/>
								<span class="red">*</span>
						</td>
						<td>
	        ...
	        <div class="fb-bom">
	        	...
	        	<cite><input type="button" value="提  交" class="sbt" onclick="Onsubmit()" id="btnfinish"/></cite>
