...
<html>
                ...
                <table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
		          ...
		          <c:forEach items="${requestScope.boxitemlist}" var="boxitem">
			  	  <tr class="fb-list">
			  		...
			  		<td width="20%">${boxitem.boxitemweight }&nbsp;</td>
			  	  </tr>
		  		  </c:forEach>
		        </table>
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findTabletInStorItem_tablet.shtml"
	...
	<script type="text/javascript">
	    function goBack(){
	        $("#searchform").attr("action","inOutStorBox!findTabletInStorBox_tablet.shtml");
			$("#searchform").submit();
	    }
	</script>
	</body>
