...
<div id="body">
	...
	<div id="content1" style="display:block;">
		...
		<div class="form-box">    	
	    	<c:if test="${fn:length(sessionScope.tabletOutStoragemap)>0}">
	    	<div class="fb-tit">待出库饮片成功列表</div>
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.tabletOutStoragemap}" var="outstoragemap" varStatus="vs">
	              	<tr id="tr_${vs.index }">
	        ...
	        <div class="fb-tit tpline">待出库饮片失败列表</div>
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              <tr class="fbc-tit">
		...
		<div class="form-box">
	        ...
	        <div class="fb-con">
	        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	                <td width="148" align="right" height="30">企业类型：</td>
	                <td><select onchange="chooseUser(this);" name="zstype" id="zstype"><option value="0">溯源企业</option><option value="1">非溯源企业</option></select></td>
	              </tr>
	            </table>
	              
	              <!-- 溯源企业时显示-->
	              <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbody1" style="display:block;">
<%--	              <tr>--%>
...
<%--	              </tr>--%>
	              ...
	              <!-- 溯源企业时显示-->
	              <!-- 非溯源企业时显示-->
	              <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbody2" style="display:none;">
	              <tr>
...
<%--    <script language="javascript" type="text/javascript" src="<%=basePath%>js/My97DatePicker/WdatePicker.js"></script>--%>
    ...
    <script type="text/javascript">
		...
		function goBack(){
			window.location="<%=basePath %>/manage/tabletInOutStorage/findOutStorage.jsp";
		}
		...
		function findByProducecode(){
			var data=""	
			var url="<%=request.getContextPath()%>/company!findByCpccorp.shtml?rid="+Math.random();
				...
				$.getJSON(url,function(msg){
					if(msg.state=="")
					{
						$.dialog.confirm('验证成功、确认要提交吗？', function(){ 
							cm.close();						
							$("#searchform").attr("action", "inOutStor!addOutStorageTablet.shtml");
							$("#searchform").submit();	
