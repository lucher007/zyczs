...
<body>
    <div id="body">
	    <div class="cur-pos">当前位置：饮片库存管理  &gt; 入库查询</div>
	    <div class="seh-box">
	        <form action="" method="post" name="searchform" id="searchform">
				品名：<input maxlength="20" type="text" value="${prodname}" size="30" class="inp"  id="prodname" name="prodname">
				入库时间： 从
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
		  	   <tr class="lb-list">
		  		...
		  		<td>
					<a class="btn-look" href="<%=basePath %>inOutStorBox!findTabletInStorBox_tablet.shtml?inoutstorid=${inoutstorage.inoutstorid }">详情</a>
				</td> 
		  	  </tr>
	  		  </c:forEach>
	        </table>
	        <div class="page">
				<cite>
				<pg:pager url="inOutStor!findTabletInStor_tablet.shtml"
