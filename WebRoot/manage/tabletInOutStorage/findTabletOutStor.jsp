...
<html>
	...
	<body>
    <div id="body">
	    <div class="cur-pos">当前位置：饮片库存管理 &gt; 出库查询</div>
	    <div class="seh-box">
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
		  	   <tr class="lb-list">
		  		...
		  		<td width="25%">${inoutstorage.buycorpname==null?'--':inoutstorage.buycorpname }&nbsp;</td>
		  		<td width="20%">${fn:substring(inoutstorage.opertime, 0, 11)}&nbsp;</td>
		  		<td width="15%">${inoutstorage.operator==null?'--':inoutstorage.operator }&nbsp;</td>
		  		<td width="15%">${inoutstorage.strtotalmoney==null?'--':inoutstorage.strtotalmoney }&nbsp;</td>
		  		<td width="10%">
					<a class="btn-look" href="<%=basePath %>inOutStorBox!findTabletOutStorBox_tablet.shtml?inoutstorid=${inoutstorage.inoutstorid }">详情</a>
				</td> 
		  	  </tr>
	  		  </c:forEach>
	        </table>
	        <div class="page">
				<cite>
				<pg:pager url="inOutStor!findTabletOutStor_tablet.shtml"
