...
<html>
	...
	<body>
	<div id="body">
		<div class="cur-pos">当前位置：用户管理 > 用户查询</div>
	    <div class="seh-box">
	    	<cite><a href="javascript:roleFindByList(${requestScope.orgid });" class="btn-a"><span class="new">权限管理</span></a></cite>
	    	<cite>&nbsp;&nbsp;</cite>
	    	<cite><a href="javascript:saveInit_UserSys(${requestScope.orgid });" class="btn-a"><span class="new">添加用户</span></a></cite>
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr class="lb-list">
	            ...
	            <td><a href="javascript:updateInit(${userlist.userid },${userlist.org.orgid });" class="btn-look">编辑</a> </td>
	          </tr>
	          </c:forEach>
	        </table>
	        <div class="page">
	...
	function updateInit(userid,orgid){
		$("#searchform").attr("action", "user!updateInit_sys.shtml?userid="+userid+"&orgid="+orgid);
		$("#searchform").submit();
	}
	function checkForm(){
		...
		$("#searchform").attr("action","user!findByList_sys.shtml");
		$("#searchform").submit();
	}
	function saveInit_UserSys(orgid){
		$("#searchform").attr("action", "user!saveInit_sys.shtml?orgid="+orgid);
		$("#searchform").submit();
	}
