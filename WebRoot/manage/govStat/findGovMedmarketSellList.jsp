...
<body>
<div id="body">
	<div class="cur-pos">当前位置：库存销售 &gt; 中药材流通</div>
    <div class="form-box">
    	<div class="fb-tit">
        	<div class="fbt-tab">
                <a href="<%=basePath %>govmentMedStat!findMedmarketByList.shtml" >库存统计列表</a>
                <a href="<%=basePath %>govmentMedStat!findMedmarketSellByList.shtml" class="act">销售统计列表</a>
            </div>
        </div>
        <div class="fb-con">
        	<div class="fb-tip">
        		<form action="<%=basePath %>govmentMedStat!findMedmarketSellByList.shtml" method="post" id="searchform">
		            	<table>
		                  <tr>
		                  ...
		                  <tr>
		                    ...
		                    <td><input type="button" value="搜索" class="sch" onclick="query()"></td>
		                  </tr>
		                </table>
		                </form>
		            </div>
            ...
            <div class="page">
				<cite>
				<pg:pager url="govmentMedStat!findMedmarketSellByList.shtml"
