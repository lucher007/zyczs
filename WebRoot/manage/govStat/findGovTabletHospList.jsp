...
<%--	                <td align="center">${item.cpctabletCount}</td>--%>
	                <td align="center">${item.outtotalweight}</td>
            ...
            <div class="page">
                <cite>
				<pg:pager url="govmentTabletStat!findByTabletHospList.shtml"
...
function checkForm(){
	...
	*/
	$("#searchform").attr("action","govmentTabletStat!findByTabletHospList.shtml");
	$("#searchform").submit();
}
...
function selOrg(){
	t2 = $.dialog({
		...
		id:'orgChos',
		lock:true,
		content: '<iframe frameborder="0" scrolling="no" name="tFrame" id="tFrame" width="650" height="300" src="<%=basePath%>org!findByListChoice.shtml?zyctype=00000100&rid='+Math.random()+'"></iframe>',
		max:false,
		min:false
	});			
}
