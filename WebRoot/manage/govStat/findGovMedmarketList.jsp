...
<div id="body">
    ...
    <div class="form-box">
        ...
        <div class="fb-con">
        	<div class="fb-tip">
        		<form action="<%=basePath %>govmentMedStat!findMedmarketByList.shtml" method="post" id="searchform">
		            	<table border="0">
		                  <tr>
		                    <td height="26" width="90" align="right">药材名称：</td>
		                    <td colspan="3">
		                  	  <input type="text" class="inp fl w250" id="medname" name="medname" maxlength="20" value="${medname }"/>
					  		  <a href="javascript:void(0);" id="xzyc" class="btn-xz fl">选择</a>
		                    </td>
		                   	<!--<td align="right">经营户：</td>
		                    <td><input type="text" class="inp w150" id="corpname" name="corpname"></td>-->
		                  </tr>
		                  <tr>
		        	...
		        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
		              <tr class="fbc-tit">
		                ...
		                <td align="center">经营户数量</td>
		                <td align="center">药材品种数量</td>
		                <td align="center">进货总量 (Kg)</td>
		                <td align="center">进货批次数量</td>
		                <td align="center">产地数量</td>
		                <td align="center">溯源码数量</td>
		              </tr>
		              <c:forEach items="${list}" var="item">
			              <tr class="fb-list">
			                <td align="center" height="30">${item.mon }&nbsp;</td>
			                <td align="center">${item.usernum }&nbsp;</td>
			                <td align="center">${item.mednamenum }&nbsp;</td>
			                <td align="center">${item.medweight }&nbsp;</td>
			                <td align="center">${item.cpcmednum }&nbsp;</td>
			                <td align="center">${item.areanum }&nbsp;</td>
			                <td align="center">${item.mednum }&nbsp;</td>
			              </tr>
			         </c:forEach>
		            </table>
            <div class="page">
				<cite>
				<pg:pager url="govmentMedStat!findMedmarketByList.shtml"
