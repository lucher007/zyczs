...
<%--                <td align="center">销售总量(kg)</td>--%>
              ...
              <c:set var="totaltabletweight" value="${item.totaltabletweight}" scope="request" /> 
              <%
	            Object boxitemnumall=request.getAttribute("totaltabletweight");
	          %>
	              ...
	              <tr class="fb-list">
	                ...
	                <td align="center"><%=Tools.scienceToString(Tools.division(boxitemnumall.toString(),"10000"))%></td>                
<%--	                <td align="center">${item.codeCount}</td>--%>
            ...
            <div class="page">
                <cite>
				<pg:pager url="govmentTabletStat!findByTabletList.shtml"
...
function checkForm(){
	...
	*/
	$("#searchform").attr("action","govmentTabletStat!findByTabletList.shtml");
	$("#searchform").submit();
}
...
function selOrg(){
	t2 = $.dialog({
		...
		id:'orgChos',
		lock:true,
		content: '<iframe frameborder="0" scrolling="no" name="tFrame" id="tFrame" width="650" height="300" src="<%=basePath%>org!findByListChoice.shtml?zyctype=00100000&rid='+Math.random()+'"></iframe>',
		max:false,
		min:false
	});			
}
