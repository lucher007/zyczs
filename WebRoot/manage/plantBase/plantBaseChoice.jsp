...
<html>
	...
	<div id="body">
	    <div class="seh-box">
	        <form id="searchform" name="searchform" action="<%=request.getContextPath()%>/plantBase!plantBaseChoice.shtml" method="post">
	        <table cellpadding="0" cellspacing="0" width="100%" border="0">
	  			<tr>
	  				<td width="80">植物名称：</td>
	  				<td><input type="text" class="inp" name="mcontent" id="mcontent"  value="${mcontent}" /></td>
	  				<td width="80">植物编码：</td>
	  				<td><input type="text" class="inp" name="sourceid"  id="sourceid" value="${requestScope.sourceid }" /></td>				
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
         	...
         	<div class="page">
        		<cite>
            		<pg:pager
				    url="plantBase!plantBaseChoice.shtml"
