...
<!--	 			</table>-->
                ...
                <table id="source" width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
		          ...
		          <c:forEach items="${requestScope.inoutstorboxlist}" var="inoutstorbox">
			  	  <tr class="fb-list">
			  		...
			  		<td><a href="<%=basePath %>inOutStorBox!findMedInStorItem_medSell.shtml?inoutstorboxid=${inoutstorbox.inoutstorboxid }&inoutstorid=${requestScope.inoutstorid }" class="btn-bag">${inoutstorbox.boxnum }&nbsp;</a></td>
		        ...
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findMedInStorBox_medSell.shtml"
