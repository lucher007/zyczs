	...
	<div id="body">
		...
		<div class="form-box">
	        ...
	        <div class="fb-con">
                ...
                <table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
		          ...
		          <c:forEach items="${requestScope.inoutstorboxlist}" var="inoutstorbox">
			  	  <tr class="fb-list">
			  		...
			  		<td><a href="<%=basePath %>inOutStorBox!findMedOutStorItem_medSell.shtml?inoutstorboxid=${inoutstorbox.inoutstorboxid }&inoutstorid=${requestScope.inoutstorid }" class="btn-bag">${inoutstorbox.boxnum }</a></td>
		        ...
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findMedOutStorBox_medSell.shtml"
