...
<body>
    <div id="body">
	    <div class="cur-pos">当前位置：库存出库 &gt; 出库查询</div>
	    <div class="seh-box">
	    ...
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
		  	   <tr class="lb-list">
		  		...
		  		<td width="10%">
					<a class="btn-look" href="<%=basePath %>inOutStorBox!findMedOutStorBox_medSell.shtml?inoutstorid=${inoutstorage.inoutstorid }">详情</a>
				</td> 
		  	  </tr>
	  		  </c:forEach>
	        </table>
	        <div class="page">
				<cite>
				<pg:pager url="inOutStor!findMedOutStor_medSell.shtml"
...
<script type="text/javascript">
	function checkForm(){
		...
		$("#searchform").attr("action","inOutStor!findMedOutStor_medSell.shtml");
		$("#searchform").submit();
	}	   
</script>
