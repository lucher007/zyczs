...
<div id="body">
		...
		<div class="form-box">
	    	<c:if test="${fn:length(sessionScope.medSellInStoragemap.listMap)>0}">
	        ...
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.medSellInStoragemap.listMap}" var="instoragemap" varStatus="vs">
	        ...
	        <c:if test="${fn:length(sessionScope.medSellInStoragemap.failList)>0}">	
	        ...
	        <div class="fb-con">
	        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
	              ...
	              <c:forEach items="${sessionScope.medSellInStoragemap.failList}" var="failList">              
	              <tr class="fb-list">
    ...
    <script type="text/javascript">
		...
		function goBack(){
			window.location="<%=basePath %>/manage/medSellInOutStorage/findInStorage.jsp";
		}	

		function checkForm(){
			$("#searchform").attr("action", "medSellInOut!addInStorage.shtml");
