	...
	<div id="body">
		<div id="content1" style="display:block;">
			...
			<div class="form-box">
	    		...
	    		<c:if test="${fn:length(sessionScope.medSellOutStoragemap)>0}">
	        	...
	        	<div class="fb-con">
		        	<table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10" id="content">
		              ...
		              <c:forEach items="${sessionScope.medSellOutStoragemap}" var="outstoragemap" varStatus="vs">
		              	<tr id="tr_${vs.index }">		              
		        	...
		        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		                ...
		                <td colspan="3" width="574">
			                <select onchange="chooseUser(this);" name="zstype" id="zstype">
			                	<option value="0">溯源企业</option><option value="1">非溯源企业</option>
			                </select>
		                </td>
		              </tr>
		              <!-- 溯源企业时显示-->
...
<%--    <script language="javascript" type="text/javascript" src="<%=basePath%>js/My97DatePicker/WdatePicker.js"></script>--%>
    <script type="text/javascript">
		...
		function goBack(){
			window.location="<%=basePath %>/manage/medSellInOutStorage/findOutStorage.jsp";
		}
				...
				$.getJSON(url,function(msg){
					if(msg.state=="")
					{
						$.dialog.confirm('验证成功、确认要提交吗？', function(){ 
							cm.close();						
							$("#searchform").attr("action", "medSellInOut!addOutStorage.shtml");
							$("#searchform").submit();	
