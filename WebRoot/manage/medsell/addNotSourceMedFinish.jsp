		...
		<script type="text/javascript" language="javascript">
			...
			*/
			function findByList(medstorid,cpcmed,medname,medweight){
				window.location.href="<%=basePath%>manage/check/medCheck.jsp?medstorid="+medstorid+"&cpcmed="+cpcmed+"&medname="+encodeURI(medname)+"&medweight="+medweight+"&flag=3&checkmattype=0";
				cMenu(1,0);
			}
			/**
			*药材分包
			*/
			function goToUrl(){
				window.location.href = "<%=basePath%>medSell!findNotPackList.shtml";
				cMenu(0,3);
			}
  		</script>
	</body>
