...
<html>
	...
	<div id="body">
		...
		<div class="lst-box">
			...
			<div class="page">
				<cite>
				<pg:pager url="medSell!findPrintCode.shtml"
	...
	function checkForm(){
		...
		$("#searchform").attr("action","medSell!findPrintCode.shtml");
		$("#searchform").submit();
	}
	cMenu(0,4);
    ...
    function printData_print(storageidtemp){
		$.dialog({
			...
			id:'medChos',
			lock:true,
			content: '<iframe frameborder="0" scrolling="no" name="tFrame" id="tFrame" width="800" height="580" src="<%=basePath%>printCode!findByStorageId_med.shtml?ischoice='+Math.random()+'&storageid='+storageidtemp+'&url=medSell!findPrintCode.shtml"></iframe>',
			close:function(){
