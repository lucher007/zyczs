...
<html>
	...
	<div id="body">
		...
		<div class="lst-box">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<c:forEach items="${list}" var="item">
					<tr class="lb-list">
						...
						<td>
							<a href="<%=basePath %>medSell!findPackByCpcMed.shtml?cpcmed=${item.cpcmed }&medstorid=${item.medstorid}" class="btn-bag">分包</a>
						</td>
					</tr>
				</c:forEach>
			</table>
			...
			<div class="page">
				<cite>
				<pg:pager url="medSell!findNotPackList.shtml"
	...
	<script type="text/javascript">
		...
		function checkForm(){
			...
			$("#searchform").attr("action","medSell!findNotPackList.shtml");
			$("#searchform").submit();
		}
    </script>
</body>
