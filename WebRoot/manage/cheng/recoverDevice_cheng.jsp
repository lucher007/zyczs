...
<html>
	...
	<div id="body">
		...
		<input type="hidden" name="chengid" id="chengid" value="${requestScope.cheng.chengid }"/>
	    <div class="form-box">
    		<div class="fb-tit">溯源秤回收</div>
	       	<div class="fb-con">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		           <tr >
		            <td height="30" width="170" align="right">溯源秤编号：</td>
		            <td width="290">
		            	<input type="text" class="inp" readonly="readonly" style="background:#eeeeee;" size="39" name="chengcode" id="chengcode" maxlength="32" value="${requestScope.cheng.chengcode }" > <span class="red">*</span>
		            </td>
		            <td width="280">
		          ...
		          <tr>
		            ...
		            <td >
		            	<input type="text" class="inp" readonly="readonly" style="background:#eeeeee;" size="39" name="chengcode" id="chengcode" maxlength="32" value="${requestScope.cheng.normname }" >
		            </td>
		            <td ></td>
		          </tr>
		          <tr>
                    ...
                    <td >
                    	<input type="text"  size="25" class="inp fl" readonly="readonly" id="corpname" name="corpname" style="background:#eeeeee;" value="${requestScope.cheng.corpname}">
                    </td>
                    <td ></td>
		          </tr>
		          <tr>
                    ...
                    <td >
                    	<input type="text" size="25" class="inp" readonly="readonly" id="cpccorp" name="cpccorp" style="background:#eeeeee;" value="${requestScope.cheng.cpccorp}">
                    </td>
                    <td></td>
		          </tr>
		          <tr>
	...
	function checkDeviceCode(chengcode){
	    if(chengcode != null && chengcode != ''){
	        if(checkChars(chengcode)){
				$("#chengcode").focus();
		    ...
		    $.ajax({
		    	url: "<%=basePath%>cheng!checkDeviceCode.shtml?chengtype=1&chengcode=" + chengcode,
		    	type: 'post',
   ...
   $("#selectCpccorp").click(function(){
	...
	function recoverDevice(){
		...
		$("#searchform").attr("action", "<%=basePath%>cheng!recoverDevice_cheng.shtml");
		$("#searchform").submit();
	}
</script>   
</body>
