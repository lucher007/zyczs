...
<html>
	...
	<body>
	<div id="body">
		<div class="cur-pos">当前位置：库存管理  &gt; 销售查询</div>
		...
		<div class="form-box">
	        ...
	        <div class="fb-con">
                ...
                <table width="726" border="0" cellspacing="0" cellpadding="0" class="fbc-box ml10">
		          ...
		          <c:forEach items="${requestScope.inoutstorboxlist}" var="inoutstorbox">
			  	  <tr class="fb-list">
			  		...
			  		<td><a href="<%=basePath %>inOutStorBox!findTabletOutStorItem_tabletSell.shtml?inoutstorboxid=${inoutstorbox.inoutstorboxid }&codetype=${inoutstorbox.codetype }&inoutstorid=${requestScope.inoutstorid }" class="btn-bag">${inoutstorbox.boxnum }&nbsp;</a></td>
		        ...
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findTabletOutStorBox_tabletSell.shtml"
