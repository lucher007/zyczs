...
<!--		            <td>包数</td>-->
		          ...
		          <c:forEach items="${requestScope.boxitemlist}" var="boxitem">
			  	  <tr class="fb-list">
			  		...
			  		<td width="20%">
			  		<c:set var="boxweight" value="${boxitem.boxweight}" scope="request" />
			  			<%
...
<!--			  		<td width="20%">${boxitem.boxitemnum }</td>-->
		        ...
		        <div class="page">
					<cite>
					<pg:pager url="inOutStorBox!findTabletOutStorItem_tabletSell.shtml"
	...
	<script type="text/javascript">
		function goBack(){
	        $("#searchform").attr("action","inOutStorBox!findTabletOutStorBox_tabletSell.shtml");
			$("#searchform").submit();
	    }
	</script>
	</body>
