...
<html>
	...
	<body>
	<div id="body">
		<div class="cur-pos">当前位置：饮片库存管理 &gt; 饮片出库</div>
	    <div class="seh-box">
	    	<cite><a href="/manage/tabletSellInOutStorage/findOutCode.jsp" class="btn-a"><span class="out">饮片出库</span></a></cite>
	    	<form action="" method="post" name="searchform" id="searchform">
	    	品名：<input type="text" maxlength="50" name="tabletname" id="tabletname" value="${requestScope.tabletname}"  class="inp" size="30"> 
	    	包装类型：<select id="codetype" name="codetype" class="w100">
...
<!--		            </td>-->
		            ...
		            <td><a href="printCode!findByBox.shtml?storageid=${tabletStoragelist.tabletstorid }&codetype=${requestScope.codetype }&storagetype=1">查看溯源码</a></td>
	            </c:if>
	            <c:if test="${requestScope.codetype ==6 }">
	            	<td height="30">${tabletStoragelist.tabletname }&nbsp;</td>
<!--			  		<td>-->
...
<!--		            </td>-->
	            ...
	            <c:if test="${requestScope.codetype ==8 || requestScope.codetype ==0}">
	            	<td height="30">--大包装--</td>
	            	<td>
			  		<c:set var="tabletweight" value="${tabletStoragelist.tabletweight}" scope="request" />
	           		 <%
	        ...
	        <div class="page">
	        	<cite>
					<pg:pager
					    url="tabletStorage!findByListUnOut.shtml"
	...
	<script type="text/javascript">
		function checkForm(){
			...
			$("#searchform").attr("action","tabletStorage!findByListUnOut_tabletSell.shtml");
			$("#searchform").submit();
		}
