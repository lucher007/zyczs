...
<html>
	...
	<div id="body">
	    ...
	    <c:if test="${fn:length(requestScope.inoutstoragelist)>0}">
	    <div class="lst-box">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <%int key=1; %>
	          <c:forEach items="${requestScope.inoutstoragelist}" var="list">
	          <tr class="lb-list">
	            <td width="" height="30">
	            <input type="radio"  name="_selKey"  value="<%=key%>">
	            <input type="hidden" id="buycorpname_<%=key%>" value="${list.buycorpname }" >
	            <input type="hidden" id="cpccorp_<%=key%>" value="${list.cpccorp }" >		            		
	            </td>
	            <td>${list.buycorpname }&nbsp;</td>
	            <td width="100">${list.cpccorp }&nbsp;</td>
         	...
         	<div class="page">
        		<cite>
            		<pg:pager
				    url="tabletSellInOut!companyChoice.shtml"
					...
					<pg:param name="stortype" value="${requestScope.stortype }"/>
