...
<div id="body">
	...
	<div class="form-box">
    	<div class="fb-tit">待拆包饮片 <b class="red f12">提示：扫描大包装后查询即可</b></div>
        <div class="fb-con">
...
<script type="text/javascript">
	...
	function getCode2(boxcodes){
		...
		if(type=="5"||type=="6"){
			$.dialog.tips('该溯源码不是大包装、不能拆包',2,'alert.gif');
			$("#boxcodes").val("");
			return;
		}	
		...
		$.getJSON(url,function(msg){
			if(msg.returnCode==1){
				...
				if(packcode.length>=25){
					$.dialog.tips('该箱饮片已经被包装、不能重复操作',2,'alert.gif');
					$("#boxcodes").val("");
					return;
				}
	...
	function showData(obj,code){ 
		...
		var boxweight=division(obj.boxweight,10000);
 		...
 		htmlStr+='<td height="30" id="name'+keyid+'">大包装</td>'; //品名
