	        ...
	        <table border="0" width="100%">
                  <tr>
                    <td height="26"  align="right">品名：</td>
	                 <td>
	                    <input maxlength="20" type="text" name="tabletname" id="tabletname" value="${requestScope.tabletname }" class="inp"/>
	                </td>
...
<!--		  		<td>${tabletStatlist.boxnum }&nbsp;</td> -->
	        ...
	        <div class="page">
	        	<cite>
					<pg:pager
					    url="tabletSellStat!getTabletSellStat.shtml"
	...
	<script type="text/javascript">
		function checkForm(){
			...
			$("#searchform").attr("action","tabletSellStat!getTabletSellStat.shtml");
			$("#searchform").submit();
		}
    </script>
	</body>
