...
<!--		                   销售企业名称： <input maxlength="50" type="text" name="sellcorpname" id="sellcorpname" value="${requestScope.sellcorpname }" class="inp"/>-->
			        入库时间： 从
		    ...
		    <div class="lst-box">
		    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		          ...
		          <c:forEach items="${requestScope.inoutstoragelist}" var="inoutstorage">
			  	   <tr class="lb-list">
			  		<td height="30">
			  		   ${(inoutstorage.prodname==null || inoutstorage.prodname == '')?'--':inoutstorage.prodname }&nbsp;
			  		</td>
			  		<td>
			  		   ${(inoutstorage.opertime==null || inoutstorage.opertime == '')?'--':fn:substring(inoutstorage.opertime, 0, 11)} &nbsp;
			  		</td>
			  		<td>${inoutstorage.strtotalweight }&nbsp;</td>
			  		<td>
						<a class="btn-look" href="<%=basePath %>inOutStorBox!findMedInStorBox_medMarket.shtml?inoutstorid=${inoutstorage.inoutstorid }&zstype=${inoutstorage.zstype }">查看</a>
					</td> 
			  	  </tr>
		  		  </c:forEach>
		        </table>
		        <div class="page">
					<cite>
					<pg:pager url="inOutStor!findMedInStor_medMarket.shtml"
