...
<base href="<%=basePath%>">
<meta charset="utf-8">
<title>中药饮片使用环节追溯子系统${initParam.titlename }</title>
...
<body>
    <div id="top" class="hosp_logo"><div class="site">${initParam.titlename }</div></div>
    <div id="menu">
    	<div class="m-list">
            <cite>
...
<%--            <ul class="ml-menu">--%>
<%--              <li><a href="/manage/hospitalInOutStorage/findInStorage.jsp" target="MainFrame" class="act">&gt;&gt; 饮片入库</a></li>--%>
<%--              <li><a href="inOutStor!findTabletInStor_hospital.shtml" target="MainFrame" >&gt;&gt; 入库查询</a></li>         --%>
<%--              <li><a href="hospitalStat!findByTabletStorageStat.shtml" target="MainFrame">&gt;&gt; 库存查询</a></li>          --%>
<%--            </ul>--%>
<%--            --%>
<%--            <ul class="ml-menu hide">--%>
<%--              <li><a href="hospitalStat!getTabletBuyStat.shtml" target="MainFrame">&gt;&gt; 入库统计</a></li>--%>
<%--             --%>
<%--            </ul>--%>
<%--            --%>
<%--           <ul class="ml-menu hide">--%>
